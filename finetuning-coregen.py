...
def parse_args():
    ...
    # Model parameters
    parser.add_argument("--model_name", type=str, default="results_7b/checkpoint_80000", help="Base model name")
    ...
    parser.add_argument("--lora_target_layers_start", type=int, default=16, help="Starting layer for LoRA")
    ...
    # Data parameters
    parser.add_argument("--train_dataset", type=str, default="../CoPE/starcoder_20Btokens", help="Training dataset path")
    ...
    parser.add_argument("--output_dir", type=str, default="./results_7b", help="Output directory")
