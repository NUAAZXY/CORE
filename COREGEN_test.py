...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        self.in_line_layer = [0, 1]
        self.window_attn_layer = [2, 3, 4, 5]
        self.masking_layer = range(6, 12)
    ...
    def forward(
        ...
        if self.layer_idx in self.window_attn_layer:
            ...
            bias = 0.
        attn_weights = torch.matmul(query_states, key_states.transpose(2, 3)) / math.sqrt(self.head_dim) + bias
