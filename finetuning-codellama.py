...
def get_trainable_params(model, args):
    """Get all trainable parameters (LoRA + DependencyEncoding)"""
    trainable_params = []
...
def parse_args():
    ...
    parser.add_argument("--max_train_steps", type=int, default=61035, help="Maximum training steps")
    ...
    parser.add_argument("--seq_length", type=int, default=900, help="Sequence length")
    ...
    parser.add_argument("--log_step", type=int, default=10000, help="Log steps")
    parser.add_argument("--output_dir", type=str, default="./results_7b_codellama", help="Output directory")
