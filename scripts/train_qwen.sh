#!/bin/bash
# COREGEN two-stage training for Qwen2.5-Coder-7B on 4x 4090
...
if [ "$STAGE" = "1" ]; then
    ...
    accelerate launch --num_processes 4 --mixed_precision bf16 \
        finetuning-qwen.py \
        --stage 1 \
        --model_name ~/models/Qwen2.5-Coder-7B \
        --train_batch_size 2 \
        --learning_rate 5e-5 \
        ...
        --log_step 1000 \
        --output_dir ./results_qwen_s1 \
        --project_name COREGEN-Qwen-S1 \
    ...
    accelerate launch --num_processes 4 --mixed_precision bf16 \
        finetuning-qwen.py \
        --stage 2 \
        --model_name ./results_qwen_s1/final_checkpoint \
        --lora_rank 32 \
        --lora_alpha 32 \
        ...
        --log_step 500 \
        --output_dir ./results_qwen_s2 \
        --project_name COREGEN-Qwen-S2 \
        --gradient_checkpointing \
        "$@"
else
