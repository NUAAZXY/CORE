...
from COREGEN13b import LlamaForCausalLM
...
def parse_args():
    ...
    # Model parameters
    parser.add_argument("--model_name", type=str, default="codellama-13b", help="Base model name")
    ...
    parser.add_argument("--max_train_steps", type=int, default=61035*2, help="Maximum training steps")
