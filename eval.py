...
def eval(
    path="pred_2048_mask_6000",
    # path="pred_codellama",
    # path='/home/user/PycharmProjects/COREGEN/results/COREGEN-python',
    # path="/home/user/PycharmProjects/COREGEN/results_repo/checkpoint_6000-python",
